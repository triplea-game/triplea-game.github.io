...
## [2.3.22091](https://github.com/triplea-game/triplea/releases/tag/2.3.22091) Oct .., 2020

|[#7899](https://github.com/triplea-game/triplea/pull/7899)|UPDATE|Removed from \"infrastructure\" units the ability to be immune to targeted (AA-like) fire and made infrastructures targetable also beyond the first round of combat (in accordance to the fact that TripleA allows infrastructures to remain in combat beyond the first round of it).|
...
|[#7871](https://github.com/triplea-game/triplea/pull/7871)|CHANGE|Opening a save game from a newer version will warn that the versions are mismatched|
|[#7834](https://github.com/triplea-game/triplea/pull/7834)|FIX|Hard AI purchases factories/constructions again|
|[#7823](https://github.com/triplea-game/triplea/pull/7823)|UPDATE|Strings in Battle UI have been updated to be more specific|
|[#7767](https://github.com/triplea-game/triplea/pull/7767)|FIX|Non-amphibious units are sorted lower than similar amphibious units in AI casualty selection.|
...
|[#7602](https://github.com/triplea-game/triplea/pull/7602)|FIX|Disable sound options instead of showing an error message if there is no sound on installed system. |
